...
function hero() {
  return (
    <div>
      <div className=" mt-4  bg-primary px-24 py-12">
        ...
        <Image src={c4}  height="500" width="500" alt="..." />
          ...
          <div className="flex items-center justify-center  gap-4 lg:py-10">
            <div className="flex flex-col gap-4">
              <p className="px-auto text-left font-serif text-5xl font-semibold text-secondary">
                Discover a world of healthcare convenience with Chikitsa Salah
              </p>
              <p className="px-auto text-left font-sans text-xl font-thin text-white">
